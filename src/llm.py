...
class LlmManager:
    ...
    def _get_system_prompt(self) -> str:
        ...
        return (
            ...
            "il punto centrale del bookmark è circa a metà della trascrizione.  "
            ...
            "5. Se sei indeciso tra due passaggi perche magari ci sono 2 frasi simili che potrebbero essere quella giusta, o non sei sicuro della frase da scegliere o pensi che la trascrizione non sia completa, non esitare a dare un punteggio di confidence basso. \n"
            "6. Se nella trascrizione c'è solo silenzio, rumore o frasi incoerenti prive di senso letterario/narrativo, "
